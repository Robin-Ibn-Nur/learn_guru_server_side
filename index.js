...
async function run() {
  try {
    ...
    const usersCollection = client.db("learn_guru").collection("users");
    const classCollection = client.db("learn_guru").collection("class");
    const selectedClassCollection = client.db("learn_guru").collection("selectedClass");
    const paymentCollection = client.db("learn_guru").collection("payment");
    ...
    app.post('/add-a-class', async (req, res) => {
      ...
      const { className, classVideo, instructorName, instructorEmail, availableSeats, price } = addClass;
      const newClass = {
        className,
        classVideo,
        instructorName,
      ...
      console.log("add class", addClass, "newClass", newClass);
...
app.get('/', (req, res) => {
  res.send('server is running authorized by RoBiN')
})
